...
<template>
  <div class="bg-gray-700 text-white text-center min-h-screen flex flex-col">
    ...
    <main class="container mx-auto p-6 flex-1">
      <div
        v-if="choice === null"
        class="flex items-center justify-center -mx-6 flex-wrap gap-2"
      >
        <button
          @click="play('rock')"
          class="bg-white rounded-full shadow-lg w-32 md:w-64 p-12 mx-6 transition-colors duration-300 hover:bg-pink-500"
        >
        ...
        <button
          @click="play('paper')"
          class="bg-white rounded-full shadow-lg w-32 md:w-64 p-12 mx-6 transition-colors duration-300 hover:bg-green-500"
        >
          <img src="./assets/PaperIcon.svg" alt="Paper" class="w-full" />
        </button>
        <button
          @click="play('scissors')"
          class="bg-white rounded-full shadow-lg w-32 md:w-64 p-12 mx-6 transition-colors duration-300 hover:bg-yellow-500"
        >
      ...
      <div class="mt-12 text-2xl"><p>Wins : Draws : Losses</p></div>
